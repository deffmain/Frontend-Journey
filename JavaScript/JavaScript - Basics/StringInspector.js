/**
 * Arquivo: StringInspector.js
 * Tema: Inspeção e extração de conteúdo em strings
 *
 * Métodos praticados:
 * - includes() → verifica se um trecho existe na string; retorna true/false
 *                e é sensível a maiúsculas/minúsculas (case-sensitive)
 * - slice()    → extrai um trecho da string a partir de índices;
 *                aceita índice negativo para contar a partir do fim
 */
